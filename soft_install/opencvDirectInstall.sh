# This is an installation bash file for OpenCV
# Acknowledgment: This is copied and slightly modified from: https://github.com/rsnk96/Ubuntu-Setup-Scripts/blob/master/opencvDirectInstall.sh
